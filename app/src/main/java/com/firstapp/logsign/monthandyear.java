...
public class monthandyear extends DialogFragment {
    ...
    public static monthandyear newInstance(int monthIndex , int daysIndex , int yearIndex) {
        monthandyear f = new monthandyear();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View dialog = inflater.inflate(R.layout.fragment_monthandyear, null);
        ...
        builder.setView(dialog)
                ...
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        monthandyear.this.getDialog().cancel();
                    }
                });
